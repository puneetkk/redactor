...
nlp = spacy.load("en_core_web_trf")  # Use a larger model for better accuracy
...
def preprocess_image(image):
    ...
    lut = [0] * 128 + [255] * 128  # Create a LUT with 256 entries
...
# Example usage
input_pdf_path = "handwritten.pdf"
output_pdf_path = "betterhandwritten_output.pdf"
